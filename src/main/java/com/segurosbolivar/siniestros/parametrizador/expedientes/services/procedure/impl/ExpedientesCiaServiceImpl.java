...
@Service
public class ExpedientesCiaServiceImpl extends StoredProcedure implements ExpedientesCiaServiceImplInterface {
    @Autowired
    DataSource dataSource;

    public ExpedientesCiaServiceImpl(DataSource dataSource){
        super(dataSource,"PKG_PARAMETROS_SINIESTRO.CREAR_EXPXCIA");
