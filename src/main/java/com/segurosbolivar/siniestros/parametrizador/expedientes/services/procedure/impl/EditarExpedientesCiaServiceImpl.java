...
@Service
public class EditarExpedientesCiaServiceImpl extends StoredProcedure implements EditarExpedienteCiaServiceInterface {

    @Autowired
    DataSource dataSource;

    public EditarExpedientesCiaServiceImpl(DataSource dataSource){
        super(dataSource,"PKG_PARAMETROS_SINIESTRO.EDITAR_EXPEDXCIA");
        ...
        declareParameter(new SqlParameter("ip_clase_exped", Types.VARCHAR));
        declareParameter(new SqlOutParameter("Op_Resultado", Types.NUMERIC));
        declareParameter(new SqlOutParameter("Op_MSG", Types.VARCHAR));
    }

    @Override
    public ExpedientesResponse EditarExpedCia(ExpedientesRequest request){
