...
import com.segurosbolivar.siniestros.parametrizador.consecuecias.services.procedures.CrearConsecuenciaSeccServiceInterface;
...
@Service
public class CrearConsecuenciaSeccServiceImpl extends StoredProcedure implements CrearConsecuenciaSeccServiceInterface {
    @Autowired
    DataSource dataSource;

    public CrearConsecuenciaSeccServiceImpl(DataSource dataSource){
        super(dataSource,"PKG_PARAMETROS_SINIESTRO.CREAR_CONSXSECC");
