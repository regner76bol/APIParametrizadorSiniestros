...
@Service
public class CrearCausasProdServiceImpl extends StoredProcedure implements CrearCausasProdServiceInterface {
@Autowired
    DataSource dataSource;

public CrearCausasProdServiceImpl(DataSource dataSource){
    super(dataSource,"PKG_PARAMETROS_SINIESTRO.CREAR_CAUSAXPROD");
