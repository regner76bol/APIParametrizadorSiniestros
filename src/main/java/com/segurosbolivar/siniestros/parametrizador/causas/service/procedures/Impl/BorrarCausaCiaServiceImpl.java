...
@Service
public class BorrarCausaCiaServiceImpl extends StoredProcedure implements BorrarCausaCiaServiceInterface {
    @Autowired
    DataSource dataSource;

    public BorrarCausaCiaServiceImpl(DataSource dataSource){
    ...
    @Override
    public CausasResponse BorrarCausaCia(CausasRequest request){
