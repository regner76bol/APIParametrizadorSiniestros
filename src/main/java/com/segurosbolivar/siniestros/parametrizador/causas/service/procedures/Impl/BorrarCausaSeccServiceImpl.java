...
@Service
public class BorrarCausaSeccServiceImpl extends StoredProcedure implements BorrarCausaSeccServiceInterface {
    @Autowired
    DataSource dataSource;

    public BorrarCausaSeccServiceImpl(DataSource dataSource){
        super(dataSource,"PKG_PARAMETROS_SINIESTRO.BORRAR_CAUSAXSECC");
    ...
    public CausasResponse BorrarCausaSecc(CausasRequest request){
