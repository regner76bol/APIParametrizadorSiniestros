...
import com.segurosbolivar.siniestros.parametrizador.causas.service.procedures.BorrarCausasCiaInterface;
...
@Service
public class BorrarCausasCiaServiceImpl extends StoredProcedure implements BorrarCausasCiaInterface {
    @Autowired
    DataSource dataSource;

    public BorrarCausasCiaServiceImpl(DataSource dataSource){
        super(dataSource,"PKG_PARAMETROS_SINIESTRO.BORRAR_CAUSAXCIA");
    ...
    @Override
    public CausasResponse BorrarCausaPorCia(CausasRequest request){
